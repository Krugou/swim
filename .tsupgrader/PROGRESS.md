# TypeScript Package Updater

**Analyzing repository:** `c:\Users\moxch\Documents\GitHub\swim`

📦 **Found 5 package installation tasks**

**Found 11 dependencies to update**
...
Packages will be updated in 5 group(s):

1. `@types/node`
2. `recharts`, `react`, `react-dom`, `next`, `next-intl`, `lucide-react`, `framer-motion`
3. `tailwind-merge`
...
### Update Group 3/5: `tailwind-merge`

🔄 **Updating:** tailwind-merge `3.3.1` → `^3.4.0
...
### Update Group 4/5: `eslint-config-next`

🔄 **Updating:** eslint-config-next `16.0.1` → `16.1.0
...
### Update Group 5/5: `prettier`

🔄 **Updating:** prettier `3.6.2` → `^3.7.4
