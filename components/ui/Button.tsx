...
const buttonVariants = cva('neo-button', {
  variants: {
    variant: {
      ...
      link: 'text-primary underline-offset-4 hover:underline shadow-none border-0 hover:shadow-none hover:translate-x-0 hover:translate-y-0 active:translate-x-0 active:translate-y-0',
